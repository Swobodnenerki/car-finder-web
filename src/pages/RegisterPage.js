    ...
    render(){
        return(
            <div>
                ...
                <Container fluid style={{display: "flex",justifyContent: "center",alignItems: "center",height: '500px', width:'550px', backgroundColor: "white", boxShadow: "0px 4px 4px rgba(0,0,0,0.5), 0px -2px 4px rgba(0, 0, 0, 0.25)"}}>
                    <RegisterBox/>
                </Container>
            </div>
        );
